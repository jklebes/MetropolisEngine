...
#the reason the simulation and measure loop is constructed by hand here, rather than integrated in metropolisengine.py,
# is for fine control in when and how often the most computationally intensive calculations happen
# for example calling a function which updates values memoized in the system object
